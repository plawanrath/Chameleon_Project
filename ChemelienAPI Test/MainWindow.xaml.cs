...
/*
            ...
            ChameleonAPI.histagram hist = new ChameleonAPI.histagram();
            if (hist.histogram(bmp, Red, Green, Blue, rdevi, gdevi, bdevi) == true)
            {
                System.Windows.Forms.MessageBox.Show("Match Found");
                System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\Hackathon\Desktop\mywavfile.mp3");
                player.Play();
            }
            else
            {
                System.Windows.Forms.MessageBox.Show("Messages Not Found");
                System.Media.SoundPlayer player2 = new System.Media.SoundPlayer(@"C:\Users\Hackathon\Desktop\mywavfile.mp3");
                player2.Play();
            }
